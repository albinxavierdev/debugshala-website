...
const CommunitySection = () => {
  ...
  const posts = [
    ...
    "https://www.instagram.com/p/DGqK9nDTmuS/?utm_source=ig_embed&amp;utm_campaign=loading", // Example additional post
    "https://www.instagram.com/p/C0987654321/?utm_source=ig_embed&amp;utm_campaign=loading"  // Example additional post
  ];
    ...
    <section id="community" className="py-16 bg-gray-50">
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 justify-items-center">
          {/* Map over the posts array to render CommunityPost for each post */}
          {posts.map((post, index) => (
            <div key={index} className="w-full max-w-[326px] mx-auto">
